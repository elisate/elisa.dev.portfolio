        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 leading-relaxed">
              Email:{" "}
              <a
                href="mailto:dushimiyimanaelisa@gmail.com"
                className="text-gray-300 hover:text-[#32F6FF] transition-colors duration-300"
              >
            ...
            <div className="mt-6">
              ...
              <div className="flex space-x-6 animate-pulse">
                ...
                <a
                  href="https://x.com/Dushelisa?t=CnM5fqv-zMFPwspmMbxcfQ&s=09"
                  className="text-gray-400 hover:text-[#32F6FF] transition-colors duration-300"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
